  ...
  return (
    <div className="min-h-screen bg-[#0a0e17] text-white font-mono flex flex-col">
      ...
      <nav className="border-b border-white/5 px-6 py-4 flex items-center justify-between">
        ...
        <span className="text-gray-600 text-xs">auth / register</span>
      </nav>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-[#a3e635] text-xs tracking-widest uppercase mb-1">Créer un compte</p>
            <p className="text-gray-500 text-xs">progression sauvegardée dans le cloud</p>
          </div>
          ...
          <div className="border border-white/8 rounded-xl bg-[#0d1117] p-6 space-y-4">
            ...
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              <div>
                <label className="block text-gray-500 text-xs mb-1">confirmer</label>
                <input
                  type="password"
                  value={confirm}
